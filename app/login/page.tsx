    ...
    <main className="min-h-screen relative flex items-center justify-center bg-surface px-margin-mobile md:px-margin-desktop py-12">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-headline-md font-headline-md text-on-surface mb-2">Selamat Datang Kembali</h1>
          <p className="text-body-md font-body-md text-on-surface-variant">Masuk untuk mengelola reputasi bisnis Anda.</p>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur-md p-8 md:p-10 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] border border-outline-variant/50">
          ...
          {registered && (
            <div className="mb-6 p-4 bg-tertiary-container text-on-tertiary-container rounded-xl text-body-sm font-medium">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-body-sm font-body-sm text-on-surface-variant">Ingat saya</span>
              </label>
              <a href="#" className="text-label-sm font-label-sm text-primary hover:underline">Lupa Password?</a>
            </div>
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-primary text-on-primary py-3.5 rounded-full font-label-md text-label-md hover:bg-primary-container hover:text-on-primary-container disabled:opacity-70 transition-colors shadow-md text-center"
            >
              {loading ? 'Masuk...' : 'Masuk'}
            </button>
          </form>
